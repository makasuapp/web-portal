...
class Header extends Component<Props> {
  ...
  render() {
    ...
    if (this.props.user !== null) {
      rightLinks.push(<Nav.Link key="logout" onClick={this.handleLogout.bind(this)}>Logout</Nav.Link>)
    } else {
      rightLinks.push(<Nav.Link key="login" onClick={() => this.nav("/login")}>Login</Nav.Link>)
    }
